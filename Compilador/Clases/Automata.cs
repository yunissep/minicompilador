                ...
                switch (_edoAct)
                {
                    ...
                    case 1:
                        ...
                        if ((lenguaje = " \n\r\t").IndexOf(c) >= 0)
                           ...
                           if ((lenguaje = "!\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~€‚ƒ„...†‡ˆ‰Š‹ŒŽ''“”•–— ̃™š›œžŸ ¡¢£¤¥¦§ ̈©ª«¬-® ̄°±²³ ́μ¶· ̧¹º»¼½¾¿\f").IndexOf(c) >= 0)
                            _edoAct = 2;
                        else {
                    ...
                    //  Automata  id
                    case 3:
                        c = SigCar(ref i); if ((lenguaje = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz").IndexOf(c) >= 0)
                            _edoAct = 4;
                        else {
                            i = iniToken;
                            return false;
                    ...
                    //automata otros
                    case 9:
                        c = SigCar(ref i); if ((lenguaje = "=").IndexOf(c) >= 0) _edoAct = 10;
